...
merged_data_CA.shape = merged_data[merged_data.inventor_region_code == 'CA']
merged_data_NY.shape = merged_data[merged_data.inventor_region_code == 'NY']
merged_data_NY.filing_date = merged_data_NY.filing_date.astype(np.datetime64)
d = merged_data_NY.groupby('filing_date').size()
pl.figure(figsize=(20,10))
pl.title('Daily Number of Patent Applications Filed with the USPTO by Inventors from NY')
d.plot()
